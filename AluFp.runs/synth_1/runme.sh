...
HD_PWD='C:/Users/Ana/Downloads/AluFp/AluFp.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_subtract.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source alu_subtract.tcl
